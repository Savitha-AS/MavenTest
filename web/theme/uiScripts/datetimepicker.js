...
var WeekHeadColor="#D9D8E9";//var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor="#D9D8F9";//var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor="#D9D8F9";//Background color of Saturday.
var WeekDayColor="white";//Background color of weekdays.
var FontColor="blue";//color of font in Calendar day cell.
var TodayColor="#7799d6";//var TodayColor="#FFFF33";//Background color of today.
...
function RenderCssCal(bNewCal) {
  ...
  //******************End Month and Year selector in arrow******************************
	...
	for (i=0;i<7;i++) {
		vCalHeader+="<td bgcolor="+WeekHeadColor+" width='"+CellWidth+"px' class='calTD'><font color='#000000'>"+WeekDayName[i].substr(0,WeekChar)+"</font></td>\n";
	}
    ...
    if (UseImageFiles)
    {
       vCalTime+="<img onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\"); stopSpin();' src='../images/calcloseS.gif' width='16px' height='14px' onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>";
    }
    else
    {

	...
	$.alerts = {
		...
		_show : function(title, msg, value, type, callback) {
			...
			case 'alert':
				$("#popup_message")
						.after(
								'<div id="popup_panel"><ul class="btn-wrapper"><li class="btn-inner" id="popup_ok"><span>'
										+ $.alerts.okButton
										+ '</span></li></ul></div>');
				...
				break;
			case 'confirm':
				// $("#popup_message").after('<div id="popup_panel"><input
				// type="button" value="' + $.alerts.okButton + '" id="popup_ok"
				// class="ui-button ui-widget ui-state-default ui-corner-all" />
				// <input type="button" value="' + $.alerts.cancelButton + '"
				// id="popup_cancel" class="ui-button ui-widget ui-state-default
				// ui-corner-all" /></div>');
				$("#popup_message")
						.after(
								'<div id="popup_panel"><ul class="btn-wrapper"><li class="btn-inner" id="popup_ok"><span>'
										+ $.alerts.okButton
										+ '</span></li></ul> <ul class="btn-wrapper"><li class="btn-inner" id="popup_cancel"><span>'
										+ $.alerts.cancelButton
										+ '</span></li></ul></div>');
				$("#popup_ok").click(function() {
					$.alerts._hide();

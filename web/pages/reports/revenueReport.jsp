	...
	/*	$(function() {
		...
		$(function() {	
			$("#downloadReportLink").click(function() {
				$("#message_div").html("");
				if(!validateDlRevenueReport())
				{
					document.getElementById("generateRevenueReportForm").action="${pageContext.request.contextPath}/customerReport.controller.downloadRevenueReport.task";
					document.getElementById("generateRevenueReportForm").submit();
				}				
			});	
		});
	</script>
...
<body onload="keepSubMenuSelected()">
	<form method="post" id="generateRevenueReportForm">
	...
	<div id="box" style="width: 100%;">	
		...
		<div class="pagetitle">
			<h3><spring:message code="revreport.header.text"></spring:message> 
			</h3>			
		</div>	

...
public class ReactivationCustomerRequest {
	...
	private int isCustExist;
	
	
	@Override
	public String toString() {
		StringBuilder builder = new StringBuilder();
		builder.append("ReactivationCustomerRequest [custId=");
	...
	public int getIsCustExist() {
		return isCustExist;
	}

	public void setIsCustExist(int isCustExist) {

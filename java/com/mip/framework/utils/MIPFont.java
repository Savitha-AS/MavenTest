...
public final class MIPFont implements Font {

    public final static String FONT_CALIBRI = "Calibri";
    ...
    protected MIPFont(short index, FontRecord rec) {
        font = rec;
        this .index = index;
    }

    /**
     * set the name for the font (i.e. Calibri)
    ...
    /**
     * get the name for the font (i.e. Calibri)
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null)
            return false;
        if (obj instanceof  MIPFont) {
            final MIPFont other = (MIPFont) obj;
            if (font == null) {
                if (other.font != null)
                    return false;
